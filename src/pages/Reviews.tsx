...
const Reviews = () => {
  const reviews = [
    ...
    },
    {
      ...
      rating: 5,
      date: "8 июля 2024",
      text: "Первый раз обслуживала электромобиль в HybridTech. Очень довольна результатом! Сделали полную диагностику, объяснили все нюансы. Буду обращаться еще.",
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">Поделитесь своим опытом обслуживания в HybridTech</p>
            </div>
